...
class CitySearchAdapter(context: Context, layout: Int, private val fullList: List<String>) : ArrayAdapter<String>(context, layout, fullList), Filterable {
    ...
    override fun getItem(position: Int): String? =
        if (results.isNotEmpty() && position < results.size) results[position] else null
