...
class LayoutChangesActivity : BaseActivity() {
    ...
    private fun initTransition() {
        ...
        llContainer.layoutTransition = LayoutTransition().apply {
            val slideRight = ObjectAnimator.ofPropertyValuesHolder(null as Any?, PropertyValuesHolder.ofFloat(View.X, 0f, width.toFloat()))
            slideRight.duration = 300
            val scaleUp = ObjectAnimator.ofPropertyValuesHolder(null as Any?, PropertyValuesHolder.ofFloat(View.SCALE_X, 0f, 1f),
