package com.dominando.android.http
...
abstract class InternetFragment : Fragment() {
    ...
    private val pit: PendingIntent by lazy {
        PendingIntent.getBroadcast(context, 0, Intent(ACTION_CONNECTIVITY), 0)
    }
    ...
    companion object {
        const val ACTION_CONNECTIVITY = "com.dominando.android.http.CONNECTION"
    }
}