...
class PinchActivity : AppCompatActivity() {
    ...
    private val imageViewGlobalLayoutListener = object: ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private val imageViewTouchListener = View.OnTouchListener { view, motionEvent ->
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageView.viewTreeObserver.addOnGlobalLayoutListener(imageViewGlobalLayoutListener)
    }
}