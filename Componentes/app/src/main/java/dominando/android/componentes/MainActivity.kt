...
class MainActivity : AppCompatActivity() {
    ...
    private fun initSeekbar() {
        skbValue.setOnSeekBarChangeListener(object: SeekBar.OnSeekBarChangeListener {
    ...
    private fun initSwitch() {
        swtEnabled.setOnCheckedChangeListener { compoundButton, bool ->
            chkEnabled.isEnabled = compoundButton.isChecked
            tgbEnabled.isEnabled = bool
        }
    }
