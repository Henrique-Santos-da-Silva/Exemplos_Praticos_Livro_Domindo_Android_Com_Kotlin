...
class RecordAudioFragment : MultimediaFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val audioPath = MediaUtils.getLastMediaPath(requireContext(), MediaUtils.MediaType.MEDIA_AUDIO)
        if (audioPath != null) {
    ...
    private fun stopRecording() {
        if (mediaRecorder != null && isRecording) {
            ...
            isRecording = false
            audioFile?.let {
                MediaUtils.saveLastMediaPath(requireContext(), MediaUtils.MediaType.MEDIA_AUDIO, it.absolutePath)
            }
        }
    }
