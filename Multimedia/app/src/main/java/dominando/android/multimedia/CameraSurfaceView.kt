...
class CameraSurfaceView(context: Context, private val camera: Camera): SurfaceView(context), SurfaceHolder.Callback {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        try {
            if (camera.parameters.supportedPreviewSizes != null) {
                previewSize = getOptimalPreviewSize(camera.parameters.supportedPictureSizes, width, height)
