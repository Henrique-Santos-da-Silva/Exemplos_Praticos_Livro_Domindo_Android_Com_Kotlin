...
class HotelHttpTests {
    ...
    @Before fun before_each_test() {
        ...
        hotelHttp = HotelHttp(remote, hotelRepository, photoGallery)
    }
    ...
    @Test fun should_syncronize_local_hotel_with_remote_server() {
        // Given
        val hotel = Hotel(
            name = "Ritz Recife",
            rating = 5.0f
        ...
        // Then
        local_storage_should_have_hotel_status_as_update(hotel)
    }

    private fun local_storage_should_have_hotel_status_as_update(hotel: Hotel) {
