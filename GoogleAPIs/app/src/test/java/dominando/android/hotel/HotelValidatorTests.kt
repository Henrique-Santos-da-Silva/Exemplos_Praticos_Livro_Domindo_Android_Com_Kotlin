...
class HotelValidatorTests {
    ...
    @Test fun should_validate_into_for_a_valid_hotel() {
        // Junit4 Style
    ...
    @Test fun should_not_validate_info_when_name_is_outside_accepted_size() {
        val nameTooShort = validInfo.copy(address = "I")
    ...
    @Test fun should_not_validate_info_when_address_is_outside_accepted_size() {
        val bigAddress = "Av.Brigadeiro Eduardo Gomes de Brito, 546 - Lagoa da Anta, Maceió - AL, 57038-230"
