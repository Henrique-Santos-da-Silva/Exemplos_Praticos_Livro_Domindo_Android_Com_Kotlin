...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtStrike.paintFlags = Paint.STRIKE_THRU_TEXT_FLAG
        val htmlText = """
            <!DOCTYPE html>
            <html>
            <head>
            	<title>Html no Android</title>
            </head>
            <body>
    ...
    private fun initTextSpan() {
        ...
        val textBackground = "Cor Background"
        ...
        val spannebleString = SpannableString(textComplete)
        ...
        spannebleString.setSpan(
                object : ClickableSpan() {
                    override fun onClick(width: View) {
