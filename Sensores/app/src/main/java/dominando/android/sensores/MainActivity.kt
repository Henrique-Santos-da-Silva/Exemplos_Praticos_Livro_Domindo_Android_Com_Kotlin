...
class MainActivity : AppCompatActivity() {
    ...
    private val sensorListener = object: SensorEventListener {
        override fun onAccuracyChanged(sensor: Sensor?, accuracy: Int) {
            Toast.makeText(this@MainActivity, "Precisão mudou: $accuracy", Toast.LENGTH_SHORT).show()
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = ArrayAdapter(this, android.R.layout.simple_spinner_item, sensorNamesList)
    ...
    private fun registerSensor() {
        sensorManager.registerListener(sensorListener, sensorsList[selectedSensor], SensorManager.SENSOR_DELAY_NORMAL)
    }
