...
class Mp3ServiceImpl : Service(), Mp3Service {
    ...
    override val totalTime: Int
        get() {
            return if (mediaPlayer.isPlaying || isPaused) mediaPlayer.duration else 0
        }

    override val elapsedTime: Int
        get() {
            return if (mediaPlayer.isPlaying || isPaused) mediaPlayer.currentPosition else 0
        }
    ...
    private fun createNotification() {
        ...
        val notificationBuilder  = NotificationCompat.Builder(this, channelId)
            ...
            .setOngoing(true)
            .build()
        NotificationManagerCompat.from(this).notify(1, notificationBuilder)
    }
